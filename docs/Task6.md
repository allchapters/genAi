...
<span class="colour" style="color:orange"> We will be using Option 2 for our lab </span>

<span class="colour" style="color:orange">Embedding for images can be done via CLIP model.</span>
...
<span class="colour" style="color:red">Note: CLIP models are embedding models, not traditional Large Language Models (LLMs).</span>
...
<span class="colour" style="color:red"> Note: <a href="https://github.com/mlfoundations/open_clip" target="_blank">OpenCLIP</a> is an open-source implementation and extension of the original CLIP (Contrastive Language-Image Pretraining) model developed by OpenAI.</span>
...
<span class="colour" style="color:red">Note: First, create an account from the [OpenAI official website](https://platform.openai.com/).If you have already completed this step please ignore and jump to Update Google Colab envoirnment section.</span>
...
<span class="colour" style="color:red"> NOTE: To avoid errors, overlap, or dependencies from previous tasks, open a new Google Colab notebook for this step. This will ensure a clean environment and prevent any potential issues related to previous work. </span>
...
<span class="colour" style="color:red">Note: Make sure to RESTART your notebook after installing the packages</span>
...
<span class="colour" style="color:red"> Note: To save time and speed up processing in this lab, I have modified the CX-Essentials.pdf file by reducing it to only a few pages. You can download this version from the modified link provided above. </span>
...
<span class="colour" style="color:red"> Note: This process may take a few minutes to complete as we are extracting information from the PDF.</span>
...
<span class="colour" style="color:red">Note: Since we are working with a modified CX-Essentials.pdf file, you may notice that there are no pdf_elements for tables. </span>
...
tables
```
<span class="colour" style="color:red">Note: The output will be blank when running the table command.</span>
...
<span class="colour" style="color:red">Note: We will be using GPT-4o as our Multimodal to create summary </span>
...
<span class="colour" style="color:red"> Note: This will generate a list of image summaries, each corresponding to an image in the figures directory. For example, if there are 11 images extracted from the PDF, you can access the summary for the 11th image by running: image_summaries[10] </span>
...
### Let's now create our MultiVector Retriever and RAG system - incl storing summary embeddings in Vector DB

![Sum3](./assets/task6/sum3.png)

#### Create our MultiVector Retriever

* Let's install packages for chroma, our in-memory db and MultiVectorRetriever
